      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-md max-h-[90vh] overflow-hidden rounded-2xl bg-stark-white/80 backdrop-blur-xl
                       shadow-[0_24px_80px_rgba(0,0,0,0.18)] border border-white/20"
          >
            {/* header */}
            <div className="sticky top-0 z-20 bg-brand-blue/90 backdrop-blur-md text-stark-white px-6 py-4">
